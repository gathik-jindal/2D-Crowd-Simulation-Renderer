 ...
 * @param {WebGLRenderbuffer} gl The WebGL rendering context.
 * @returns {WebGLBuffer} The WebGL buffer object containing the colors
 */
function initColorBuffer(gl) {
    const faceColors = [
        [1.0, 1.0, 1.0, 1.0], // Front face: white
        [1.0, 0.0, 0.0, 1.0], // Back face: red
        [0.0, 1.0, 0.0, 1.0], // Top face: blue
    ...
    //     colors = colors.concat(faceColors[0], faceColors[1], faceColors[2], faceColors[3]);
    // }
