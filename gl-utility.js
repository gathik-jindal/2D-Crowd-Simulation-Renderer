 ...
 * @param {GLenum} bufferType The type of buffer. Usually gl.ARRAY_BUFFER or gl.ELEMENT_ARRAY_BUFFER
 * @param {WebGLBuffer} buffer The buffer to update
 * @param {BufferSource} data The new data to store in the buffer
 ...
 */
function updateBuffer(gl, bufferType, buffer, data, usage = gl.DYNAMIC_DRAW) {
